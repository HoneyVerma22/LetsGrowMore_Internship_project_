	...
	public void defaultValues() {
		...
		switch (currency) {	
			...
			case "US Dollar":
				...
				this.exchangeValues.put("INR",82.743 );
				break;
			case "Euro":
				...
				this.exchangeValues.put("INR",87.74738 );
				break;
			case "British Pound":
				...
				this.exchangeValues.put("INR",100.80 );
				break;
			case "Swiss Franc":
				...
				this.exchangeValues.put("INR",91.01 );
				break;
			case "Chinese Yuan Renminbi":
				...
				this.exchangeValues.put("INR",12.0325 );
				break;
			case "Japanese Yen":
				...
				this.exchangeValues.put("INR",0.6244 );
				break;
		}
	}
